...
@section('title', 'Zatraži novu lozniku')
    ...
    <div class="col-md-4 col-md-offset-4">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">Zatraži novu lozinku</h3>
            </div>
            <div class="panel-body">
                ...
                <fieldset>
                    ...
                    <div class="form-group  {{ ($errors->has('password_confirmation')) ? 'has-error' : '' }}">
                        <input class="form-control" placeholder="Potvrdi lozinku" name="password_confirmation" type="password" value="">
