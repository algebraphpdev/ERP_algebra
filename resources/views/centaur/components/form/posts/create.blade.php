...
@slot('elements')
    <div class="form-group @error ('avatar') has-error @enderror">
        ...
        <input class="form-control-file" name="avatar" type="file" id="image" value="{{ old('avatar') }}">
        @error('avatar')
    ...
    <div class="form-group @error ('author') has-error @enderror">
        ...
        <input class="form-control" name="author" type="text" id="author" value="{{ old('author') }}">
        @error('author')
        <div class="alert alert-danger">{{ $message }}</div>
        @enderror
    </div>
    ...
    <div class="form-group">
        ...
        <input class="form-control" name="category" type="text" id="category" value="{{ old('category') }}">
        @error('category')
        <div class="alert alert-danger">{{ $message }}</div>
        @enderror
    </div>
